...
var timeLimit = function (fn, t) {
  ...
  return async function (...args) {
    return new Promise((resolve, reject) => {
      ...
      // Call the function fn with the provided arguments
      fn(...args)
        .then((res) => resolve(res)) // If fn resolves, resolve the promise
        .catch((err) => reject(err)) // If fn rejects, reject the promise
        .finally(() => clearTimeout(id)); // Clear the timeout regardless of the outcome
    });
  };
};
